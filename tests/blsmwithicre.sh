...
--hot_ratio=100 --read_portion=100 --num=-1 --throughput=-1 --benchmarks=separate --preload_metadata=1 --open_files=3000 --hot_file_threshold=1000 \
\
...
--read_threads=8 --random_reads=-1 --writes=-1 --countdown=25000 --noise_percent=2  --buffered_merge=0 --pre_caching=1"
