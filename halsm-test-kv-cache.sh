...
# cp -rf /home/shunzi/leveldb_test/lsbmdb/temp /home/shunzi/leveldb_test/lsbmdb/temp-test-kv
# lsbm/db_bench \
# --db=/home/shunzi/leveldb_test/lsbmdb/temp-test-kv --use_existing_db=1 --monitor_log=/home/shunzi/leveldb_test/lsbmdb/kv-A-log --compaction_min_score=1 --file_size=2 \
# --write_buffer_size=64 --data_merged_each_round=8 \
# --compaction_buffer_length=231 --compaction_buffer_length=232 --compaction_buffer_length=13 \
# --range_portion=0 --range_size=100 --max_print_level=3  --print_version_info=1 --print_compaction_buffer=1 --print_dash=1 --hitratio_interval=1 \
...
# \
#  --read_key_from=0 --read_key_upto=10485760 --write_key_from=0 --write_key_upto=10485760 --key_from=0 --key_upto=10485760 \
#  --block_cache_size=170 --key_cache_size=100 --warmup=0 --read_workload=zipfian --zipfian_constant=0.99 --write_workload=zipfian --readspeed=-1 --writespeed=-1 \
# --read_threads=0 --random_reads=-1 --writes=10485760 --countdown=25000 --noise_percent=0  --buffered_merge=1 > lsbm-kv-out-A.txt
...
# lsbm/db_bench \
# --db=/home/shunzi/leveldb_test/lsbmdb/temp-test-kv --use_existing_db=1 --monitor_log=/home/shunzi/leveldb_test/lsbmdb/kv-B-log --compaction_min_score=1 --file_size=2 \
# --write_buffer_size=64 --data_merged_each_round=8 \
# --compaction_buffer_length=231 --compaction_buffer_length=232 --compaction_buffer_length=13 \
# --range_portion=0 --range_size=100 --max_print_level=3  --print_version_info=1 --print_compaction_buffer=1 --print_dash=1 --hitratio_interval=1 \
...
#  --read_key_from=0 --read_key_upto=10485760 --write_key_from=0 --write_key_upto=10485760 --key_from=0 --key_upto=10485760 \
#  --block_cache_size=170 --key_cache_size=100 --warmup=0 --read_workload=zipfian --zipfian_constant=0.99 --write_workload=zipfian --readspeed=-1 --writespeed=-1 \
# --read_threads=0 --random_reads=-1 --writes=10485760 --countdown=25000 --noise_percent=0  --buffered_merge=1 > lsbm-kv-out-B.txt
...
# lsbm/db_bench \
# --db=/home/shunzi/leveldb_test/lsbmdb/temp-test-kv --use_existing_db=1 --monitor_log=/home/shunzi/leveldb_test/lsbmdb/kv-C-log --compaction_min_score=1 --file_size=2 \
# --write_buffer_size=64 --data_merged_each_round=8 \
# --compaction_buffer_length=231 --compaction_buffer_length=232 --compaction_buffer_length=13 \
# --range_portion=0 --range_size=100 --max_print_level=3  --print_version_info=1 --print_compaction_buffer=1 --print_dash=1 --hitratio_interval=1 \
...
#  --read_key_from=0 --read_key_upto=10485760 --write_key_from=0 --write_key_upto=10485760 --key_from=0 --key_upto=10485760 \
#  --block_cache_size=170 --key_cache_size=100 --warmup=0 --read_workload=zipfian --zipfian_constant=0.99 --write_workload=zipfian --readspeed=-1 --writespeed=-1 \
# --read_threads=0 --random_reads=-1 --writes=10485760 --countdown=25000 --noise_percent=0  --buffered_merge=1 > lsbm-kv-out-C.txt
...
lsbm/db_bench \
--db=/home/shunzi/leveldb_test/lsbmdb/temp-test-kv --use_existing_db=1 --monitor_log=/home/shunzi/leveldb_test/lsbmdb/kv-D-log --compaction_min_score=1 --file_size=2 \
--write_buffer_size=64 --data_merged_each_round=8 \
--compaction_buffer_length=231 --compaction_buffer_length=232 --compaction_buffer_length=13 \
--range_portion=0 --range_size=100 --max_print_level=3  --print_version_info=1 --print_compaction_buffer=1 --print_dash=1 --hitratio_interval=1 \
--hot_ratio=100 --read_portion=95 --num=10485760 --throughput=-1 --benchmarks=mix --preload_metadata=1 --open_files=1000 --hot_file_threshold=256 \
\
 --read_key_from=0 --read_key_upto=10485760 --write_key_from=0 --write_key_upto=10485760 --key_from=0 --key_upto=10485760 \
 --block_cache_size=170 --key_cache_size=100 --warmup=0 --read_workload=latest --write_workload=latest --readspeed=-1 --writespeed=-1 \
--read_threads=0 --random_reads=-1 --writes=10485760 --countdown=25000 --noise_percent=0  --buffered_merge=1 > lsbm-kv-out-D.txt
...
# lsbm/db_bench \
# --db=/home/shunzi/leveldb_test/lsbmdb/temp-test-kv --use_existing_db=1 --monitor_log=/home/shunzi/leveldb_test/lsbmdb/kv-E-log --compaction_min_score=1 --file_size=2 \
# --write_buffer_size=64 --data_merged_each_round=8 \
# --compaction_buffer_length=231 --compaction_buffer_length=232 --compaction_buffer_length=13 \
...
#  --read_key_from=0 --read_key_upto=10485760 --write_key_from=0 --write_key_upto=10485760 --key_from=0 --key_upto=10485760 \
#  --block_cache_size=170 --key_cache_size=100 --warmup=0 --read_workload=latest --write_workload=latest --readspeed=-1 --writespeed=-1 \
# --read_threads=0 --random_reads=-1 --writes=10485760 --countdown=25000 --noise_percent=0  --buffered_merge=1 > lsbm-kv-out-E.txt
